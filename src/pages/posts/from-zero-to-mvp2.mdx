...
to gain more users and keep the current ones, and start building it. Maybe using a different stack more inclined towards performance than productivity or using the same.

That's it, it was a short series of post in which we shared our thoughts on how to build a full blown product from an idea. We hope you liked it. If you have something to tell us, we would love to hear it
